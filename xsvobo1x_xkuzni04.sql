...
CREATE TABLE Mistnost (
    cislo_mistnosti NUMERIC(7, 0),
    CONSTRAINT PK_mistnost PRIMARY KEY (cislo_mistnosti)
);

CREATE TABLE Stul (
    cislo_stolu NUMERIC(7, 0),
    cislo_mistnosti NUMERIC(7, 0),
